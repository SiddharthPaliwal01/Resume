    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Designed a user-friendly interface to streamline communication processes and reduce appointment scheduling time by 25\%.}
            \resumeItem{Planned future partnerships with local organisations and healthcare workers to boost community engagement, introducing a tracking system to monitor impact and increase participation in health initiatives.}
          \resumeItemListEnd
        \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks \& Libraries}{: TensorFlow, PyTorch, FastAPI, OpenCV, Hugging Face Transformer, GANs, LangChain} \\
     \textbf{Databases}{: MySQL, MongoDB, ChromaDB, Pinecone} \\
     \textbf{Tools}{: Git, GitHub, Docker, Blender, Figma, Canva, Linux}
    }}
 \end{itemize}
...
\section{Certifications}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
        ...
        Cloud Computing, IIT Kharagpur(NPTEL) (2024) \\
    }}
 \end{itemize}
